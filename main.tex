...
\begin{document}
  ...
  \section{Initial Post}
    ...
    \subsection{Listening: What Does it Mean?}
      Listening is defined as \hl{Placeholder}.

      \subsubsection{Effective Listening Skills}
        Listed below are the five most important listening skills in descending
          order of importance.
      ...
      \subsubsection{Effective Listening Skills}
        Listed below are the five most common downfalls commited by ineffective
          listeners, with the biggest issue being ranked as number one.
